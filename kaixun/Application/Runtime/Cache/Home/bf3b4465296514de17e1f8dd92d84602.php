...
<html lang="zh-CN" xml:lang="zh-CN">
 ...
 <body> 
  <div class="site-topbar"> 
   ...
   window.buy_num = '<?php echo U("Index/buy_num");?>';
   </script>
      ...
      <ul class="row clearfix"> 
        <?php if(is_array($alist)): $i = 0; $__LIST__ = $alist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="span5"> 
            ...
            <div class="channel-list-con clearfix">
             ...
             <p class="channel-list-btn"> <a href="javascript:void(0)" class="btn btn-line-primary" data-stat-id="15bac815540bccd9" >加入购物车</a> </p> 
