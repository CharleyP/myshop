...
<!-- saved from url=(0045)http://order.mi.com/portal?r=41218.1458877857 -->
<html lang="zh-CN" xml:lang="zh-CN">
 <head>
  ...
  <script type="text/javascript" src="/Public/Home/js/user_index.js"></script>
  <script type="text/javascript">
  window.check = '<?php echo U("Base/check");?>';
  window.url_index = '<?php echo U("Index/index");?>';
  window.getUser = '<?php echo U("User/getUser");?>';
  window.order_sum = '<?php echo U("User/order_sum");?>';
  window.record_sum = '<?php echo U("User/record_sum");?>';
  </script>
 </head> 
 <body> 
          ...
          <div class="box-bd"> 
           <div class="portal-main clearfix"> 
            <div class="user-card"> 
             ...
             <p class="tip"></p> 
             <img class="avatar" src="/Public/Home/img/user.jpg" width="150" height="150" /> 
             <p>wellcome:</p><span class="name"></span>
            </div> 
            <div class="user-actions"> 
             <ul class="action-list"> 
              <li class="user_pass">账户安全：<span class="level level-2">普通</span></li> 
             </ul> 
            </div> 
           </div> 
           <div class="portal-sub"> 
            <ul class="info-list clearfix"> 
             <li class="order_num"> <h3>我的订单：<span class="num">0</span></h3> <a href="<?php echo U('User/allorder');?>">查看所有订单<i class="iconfont"></i></a> <img src="/Public/Home/img/portal-icon-1.png"/> </li> 
             <li class="pay_buy_num"> <h3>待付款商品：<span class="num">0</span></h3> <a href="<?php echo U('Order/buy');?>">查看购物车<i class="iconfont"></i></a> <img src="/Public/Home/img/portal-icon-2.png" alt="" /> </li>
            </ul> 
           </div> 
          </div> 
         </div> 
