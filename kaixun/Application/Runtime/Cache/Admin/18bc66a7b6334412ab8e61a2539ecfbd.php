                    ...
                    <table class="table table-hover table-striped">
                      ...
                      <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="text-center"><a href="<?php echo U('Order/order',array('num'=>$vo[order_num]));?>"><?php echo ($vo["order_num"]); ?></a></td>
                            <td class="text-center"><?php echo ($vo["user_account"]); ?></td>
                            <td class="text-center"><?php echo ($vo["user_name"]); ?></td>
                            <td class="text-center"><?php echo ($vo["user_phone"]); ?></td>
                            <td class="text-center"><?php echo ($vo["user_address"]); ?></td>
                            <td class="text-center"><?php echo ($vo["order_sum"]); ?>元</td>
                            <td class="text-center"><?php echo (date('y-m-d H:i:s',$vo["order_time"])); ?></td>
