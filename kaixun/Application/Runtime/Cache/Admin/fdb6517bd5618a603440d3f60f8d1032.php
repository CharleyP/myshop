    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo U('Banner/add');?>"><i class="fa fa-circle-o"></i>图片上传</a></li>
        </ul>
      </li>
    </ul>
  </section>
        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-10 col-md-offset-1 banner-list">
              <ul>
                <?php if(is_array($bannerList)): $i = 0; $__LIST__ = $bannerList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                    <input type="hidden" value="<?php echo ($vo["banner_id"]); ?>" />
